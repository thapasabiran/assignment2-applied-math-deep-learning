...
def calculate_matrix_product(X, W):
    ...
    if(X.shape[1] == W.shape[1]):
        ...
        raise RuntimeError("dimensions of X and W should be compatible for multiplication")
    return res
...
def calculate_activation(sum_total):
    ...
    """
    res = torch.heaviside(sum_total, values=torch.tensor(0.0, dtype=sum_total.dtype, device=sum_total.device))  # TODO: implement this function 
    return res
